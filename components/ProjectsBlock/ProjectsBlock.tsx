      ...
      <div className="relative mb-3">
        ...
        {isInfoPopupOpen && windowSize.width >= 768 && (
          <div className="overflow-auto pt-4 pb-4 top-0 left-0 md:px-10 md:absolute text-whiteSecondary w-full h-full bg-darkSecondary/90 md:pt-[70px] lg:text-base">
            <div className="mb-6">
              <h3 className="mb-2 text-base font-semibold leading-normal lg:text-lg md:text-lg">
                Производственная компания Промматик
              </h3>
              <p>
                Запустил с нуля сайт компании Промматик, наполнил контентом,
                сделал базовую SEO-оптимизацию и подключил необходимые сервисы.
              </p>
            </div>

            {/* инструменты и технологии */}
            <ul className="flex flex-wrap gap-1 text-xs lg:gap-2 lg:text-sm">
              <li className="px-3 py-1 rounded-md bg-darkPrimary">1C-Bitrix</li>
              <li className="px-3 py-1 rounded-md bg-darkPrimary">Aspro</li>
              <li className="px-3 py-1 rounded-md bg-darkPrimary">SEO</li>
              <li className="px-3 py-1 rounded-md bg-darkPrimary">Битрикс24</li>
              <li className="px-3 py-1 rounded-md bg-darkPrimary">Bicall</li>
            </ul>
          </div>
        )}
        ...
        <button
          ...
          className="absolute hidden leading-6 rounded-full md:block left-5 top-5 w-9 h-9 bg-darkSecondary"
        >
          {!isInfoPopupOpen ? (
            <svg
