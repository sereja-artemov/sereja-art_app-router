...
const Hero = () => {
  return (
    <section className='container'>
      <div className='flex flex-col-reverse gap-6 px-4 py-8 rounded-3xl bg-slate-400'>
        <div>
            ...
            <div>
              ...
              <div className='flex items-center justify-between gap-5 px-4 py-1 pr-1 border rounded-full w-fit'>
          ...
          <div className='mb-5'>
            <Image className='max-w-[140px] mb-2 rounded-full' src='' alt='аватарка' />
