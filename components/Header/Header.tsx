          ...
          <nav className='mx-auto w-full left-0 flex gap-x-1.5'>
            ...
            <ul className='hidden h-auto gap-1.5 lg:flex overflow-auto'>
                  { navigationRoutes.map((route, index) => (
                      <li key={index} className={`flex ${route.count !== undefined && 'gap-3'} items-center px-6 my-0.5 border rounded-full border-gray-200/25 bg-[#2A2A2A] hover:bg-slate-50 hover:text-black`}>
