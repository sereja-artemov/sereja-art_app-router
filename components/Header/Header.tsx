    ...
    <>
        ...
        <div className='container flex gap-x-1.5 items-stretch mx-auto'>
          <nav className='mx-auto w-full left-0 flex gap-x-1.5'>
            <button type='button' className='flex grow lg:grow-0 shrink-0 p-0.5 lg:p-1 border border-slate-900/50 dark:border-slate-50 rounded-full'>
            ...
            <div className='flex'>
                {/* Кнопка меню */}
                <div onClick={openMenu} className={`lg:hidden border border-slate-900/50 rounded-full p-0.5 flex items-center`}>
                  <button className='leading-none px-4 p-0.5 border border-slate-900/50 rounded-full h-full min-w-[87px]' type='button'>
          ...
          <div className='flex justify-center items-center shrink-0 lg:mr-4'>
      ...
      {/* Popup */}
      { isMenuOpen &&  <div onClick={closeMenu} className='fixed top-0 left-0 z-40 w-full h-screen dark:bg-slate-900/50 backdrop-blur-sm'></div>}
