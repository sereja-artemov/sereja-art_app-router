---
slug: otpravka-yandex-clientid-iz-tilda-v-crm-bitriks24
...
image: http://tech.sereja-art.ru/upload/blogs/otpravka-yandex-clientid-iz-tilda-v-crm-bitriks24/clientid-preview.jpg
---
...
Вставляем в подвал сайта код, который будет вытаскивать ClientID посетителя и записывать в скрытое поле. <code>yaCounterXXXXXXXX.getClientID();</code> - не забудьте указать свой номер счетчика вместо ХХХХХХХХ.
